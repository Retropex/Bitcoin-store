export APP_BITCOIN_KNOTS_NODE_IP="10.21.21.210"
export APP_BITCOIN_KNOTS_TOR_PROXY_IP="10.21.22.208"
export APP_BITCOIN_KNOTS_I2P_DAEMON_IP="10.21.22.207"

export APP_BITCOIN_KNOTS_DATA_DIR="${EXPORTS_APP_DIR}/data/bitcoin"
export APP_BITCOIN_KNOTS_RPC_PORT="7332"
export APP_BITCOIN_KNOTS_P2P_PORT="7333"
export APP_BITCOIN_KNOTS_TOR_PORT="8334"
export APP_BITCOIN_KNOTS_ZMQ_RAWBLOCK_PORT="58332"
export APP_BITCOIN_KNOTS_ZMQ_RAWTX_PORT="58333"
export APP_BITCOIN_KNOTS_ZMQ_HASHBLOCK_PORT="58334"
export APP_BITCOIN_KNOTS_ZMQ_SEQUENCE_PORT="58335"
export APP_BITCOIN_KNOTS_ZMQ_HASHTX_PORT="48336"

# These are legacy env vars we need to keep around for DATUM compatibility
export APP_BITCOIN_KNOTS_INTERNAL_RPC_PORT="7332"
export APP_BITCOIN_KNOTS_INTERNAL_P2P_PORT="7333"
